...
namespace retry_logic
{
    ...
    class Program
    {
        ...
        private static string CnnStringFormat = "Server=tcp:moraschi.database.windows.net,1433;Initial Catalog=mini-chat;Persist Security Info=False;User ID=AppUser;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;Password="
